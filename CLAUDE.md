...
- `tests/layout.test.js` — layout algorithm coverage (53 tests, browser-loadable module via globalThis)
...
Total: 98 tests. Run all: `npm test`. Run only one suite: `node --test tests/server/session.test.js`.
