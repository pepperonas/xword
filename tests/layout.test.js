...
describe('shipped puzzles re-layout cleanly', () => {
  const cases = [
    ...
    ['geschichte-hard-01.json',   28],
    ['film-hard-01.json',         28],
    ['natur-hard-01.json',        28],
    ['literatur-hard-01.json',    13],
    ['geschichte-hard-02.json',   13],
    ['wissenschaft-hard-02.json', 13],
    ['philosophie-hard-01.json',  13],
    ['kunst-hard-02.json',        13],
    ['musik-hard-02.json',        13],
    ['geographie-hard-02.json',   13],
    ['mythologie-hard-02.json',   13],
    ['literatur-hard-02.json',    13],
    ...
    ['tech-hard-01.json',         13],
    ['tech-hard-02.json',         13],
    ['wissenschaft-hard-03.json', 13],
    ['tech-hard-03.json',         13],
    ['tech-hard-04.json',         13],
